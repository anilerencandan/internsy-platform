    ...
    return (
        <div className="page-content sm:grid grid-cols-12 gap-x-12 sm:pt-4 sm:py-6 xl:px-0 sm:px-4 px-0">
            ...
            <div className='md:col-span-3 md:flex hidden flex-col gap-y-4 border border-gray-300 rounded-lg h-fit p-4 sticky top-4'>
                ...
                <p className='text-gray-600'>Şirketleri takip ederek staj, mülakat ve maaş bilgileri anında seninle olsun.</p>
                <div className='flex justify-between items-center w-full gap-x-2 text-sm font-semibold '><div className='flex items-center gap-x-2'><FaGoogle size={16}/> Google </div><div className='flex items-center gap-x-2'>3.6 <Star fill='black' size={16}/></div></div>
                <div className='flex items-center justify-center py-2'>
                    <button className='px-4 py-2 rounded-lg bg-black font-bold w-fit text-white'>Şirketleri Keşfet</button>
                </div>
                </div>
            ...
            {/* Sağ */}
            <div className="xl:col-span-3 xl:flex hidden flex-col  gap-y-4 border border-gray-300 rounded-lg h-fit p-4 sticky top-4">
                <StajIlanlarCard/>
            </div>
        </div>
    )
