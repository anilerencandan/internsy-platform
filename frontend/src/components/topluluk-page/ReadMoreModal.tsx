...
export default function CommentModal({ open, onClose, post, commented }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] p-0 overflow-hidden bg-white border text-gray-900">
        {/* Header */}
        <div className="relative p-6">
          <h1 className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 text-xl font-semibold text-primary">
        ...
        <div className="overflow-y-auto" style={{ maxHeight: "calc(90vh - 140px)" }}>
          ...
          <div className="p-6">
            ...
            <div className="flex items-center gap-3">
              <Avatar className="h-10 w-10">
                ...
                <div className="flex flex-col justify-center">
                  <h2 className="font-semibold text-primary text-sm">{post.communities?.name || "Topluluk"}</h2>
                  <p className="text-sm text-gray-500">Anonim</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-xs text-gray-500">{new Date(post.created_at).toLocaleString("tr-TR", { dateStyle: "short", timeStyle: "short" })}</span>
                <DropdownMenu>
            ...
            <div className="mb-4">
              <p className="text-gray-900 text-sm font-sans leading-relaxed whitespace-pre-line">{post.content}</p>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div className="flex-1">
                <Textarea
                  ...
                  className="min-h-[80px] resize-none border border-gray-200 p-2 text-sm"
                />
          ...
          <div className="flex items-center justify-end px-6 py-3 ">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="sm" className="h-5 w-5 flex items-center gap-2 text-gray-700">
            ...
            <div className="space-y-6">
                    ...
                    <div className="flex-1">
                      <div className="bg-gray-100 p-4">
                        <div className="flex items-center justify-between mb-2">
                          <h3 className="font-semibold text-gray-900 text-sm">{c.user_name || "Claims Specialist 1"}</h3>
                          <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-6">
                          <Button
                            ...
                            className={`flex items-center gap-2 p-0 ${
                              c.is_liked ? "text-blue-600" : "text-gray-600"
                            }`}
                          >
                            <Heart className={`h-4 w-4 text-gray-500 ${c.is_liked ? "fill-current" : ""}`} />
                            <span className="text-sm">Beğen</span>
                          </Button>
                          <Button
                            variant="ghost"
                            ...
                            className="flex items-center gap-2 text-gray-600 p-0"
                          >
                        ...
                        <div className="mt-4 flex gap-3">
                          ...
                          <div className="flex-1">
                            <Textarea
                              ...
                              className="min-h-[60px] resize-none border border-gray-200 p-2 text-sm"
                            />
                                      ...
                                      <DropdownMenu>
                                        <DropdownMenuTrigger asChild>
                                          <Button
                                            variant="ghost"
                                            size="sm"
                                            className="h-5 w-5 p-0 opacity-0 group-hover/reply:opacity-100 transition-opacity"
                                          >
              ...
              {comments.length > 5 && !showAllComments && (
                <Button
                  ...
                  className="w-full h-10 text-blue-600"
                >
          ...
          <div className="px-6 py-4 border-t border-gray-100">
            <h3 className="text-sm font-semibold text-gray-900 mb-4">Beğenebileceğiniz diğer gönderiler</h3>
            <div className="flex items-start gap-3 p-4 cursor-pointer transition-colors hover:text-primary">
              <Avatar className="h-10 w-10">
                <AvatarFallback>
                  <User className="h-5 w-5" />
                </AvatarFallback>
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="font-semibold text-gray-900 text-sm">DENEME TOPLULUK</h4>
                    <p className="text-xs text-gray-500">LPN</p>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-xs text-gray-500">3w</span>
                    <Button variant="ghost" size="sm" className="h-5 w-5 p-0">
                      <MoreHorizontal className="h-4 w-4 text-gray-500" />
                    </Button>
                  </div>
